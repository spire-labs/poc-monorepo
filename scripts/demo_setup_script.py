...
PROPOSER_2_PRIVATE_KEY=PROPOSER_3_PRIVATE_KEY=PROPOSER_4_PRIVATE_KEY=PROPOSER_1_PRIVATE_KEY
PROPOSER_2_ADDRESS=PROPOSER_3_ADDRESS=PROPOSER_4_ADDRESS=PROPOSER_1_ADDRESS

# Test account (1)
GATEWAY_API_PRIVATE_KEY="0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d"
...
def start_anvil(port):
    ...
    anvil_command = f"nohup anvil --block-time 12 --host 0.0.0.0 --port {port} > ~/anvil_logs_{port}.log 2>&1 &"
